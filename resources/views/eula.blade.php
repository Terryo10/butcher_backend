...
<head>
    ...
    <!--====== Title ======-->
    <title>Yamba App EULA Agreement</title>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-7 col-sm-6 col-6 order-2 order-sm-3">
                    <div class="appie-btn-box text-right">
                        <a class="main-btn ml-30" href="about"
                        >About App</a
                        >
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-7">
                <div class="single-post-area">
                    <br />
                    <h1 class="article-title">END USER LICENCE AGREEMENT</h1>
                    <br />
                    <p>Last updated 25/02/2023</p>
                    <p>
                        Yamba is licensed to You (End-User) by Tradersmark Pvt Ltd,
                        located and registered at 3 Aberdeen Rd, Harare, Zimbabwe,
                        Harare, Zimbabwe ('Licensor'), for use only under the terms of
                    ...
                    <p>
                        ...
                        and support thereof. Tradersmark Pvt Ltd, not the Services, is
                    ...
                    <p>
                        ...
                        Media Services Terms and Conditions ('Usage Rules'). Tradersmark
                        Pvt Ltd acknowledges that it and the opportunity to review the
                        Usage Rules and this Licence Agreement is not conflicting with
                        them.
                    </p>
                    <p>
                        Future+ when purchased or downloaded through the Services, is
                        licensed to You for use only under the terms of this Licence
                        Agreement. The Licensor reserves all rights not expressly
                        granted to You. Future+ is to be used on devices that operate
                        with Apple's operating systems ('iOS' and 'Mac OS').
                    </p>
                    <h4 class="article-title">1 THE APPLICATION</h4>
                    <p>
                        Future+ ('Licensed Application') is a piece of software created
                        to give students access to information about sexual and
                        reproductive health, professional counselling, peer counselling
                        and helplines and customised for iOS mobile devices ('Devices').
                        It is used to Access information about sexual and reproductive
                        health, professional counselling, peer counselling and
                        helplines.
                    </p>
                    <h4 class="article-title">2 SCOPE OF LICENCE</h4>
                    <p>
                    ...
                    <p>
                        ...
                        Rules, and with Tradersmark Pvt Ltd's prior written consent),
                    ...
                    <p>
                        ...
                        Tradersmark Pvt Ltd's prior written consent).
                    </p>
                    <p>
                    ...
                    <h4 class="article-title">3 TECHNICAL REQUIREMENTS</h4>
                    <p>
                    ...
                    <p>
                        4.2 Tradersmark Pvt Ltd and the End-User acknowledge that the
                        Services have no obligation whatsoever to furnish any
                        maintenance and support services with respect to the Licensed
                        Application.
                    </p>
                    <h4 class="article-title">5 USE OF DATA</h4>
                    <p>
                        5.1 You acknowledge that Licensor Will be able to access and
                        adjust Your downloaded Licensed Application content and Your
                        personal information, and that Licensors use of such material
                        and information is subject to Your legal agreements with
                        Licensor and Licensor's privacy policy, which can be found at
                        the bottom of the Licensed Application
                    </p>
                    <p>
                        5.2 You acknowledge that the Licensor may periodically collect
                        and use technical data and related information about your
                        device, system, and application software, and peripherals, offer
                        product support, facilitate the software updates, and for
                        purposes of providing other services to you (if any) related to
                        the Licensed Application Licensor may also use this information
                        to improve its products or to provide services or technologies
                        to you, as long as it is in a form that does not personally
                        identify you.
                    </p>
                    <h4 class="article-title">6 USER-GENERATED CONTRIBUTIONS</h4>
                    <p>
                    ...
                    <p>
                        6.1 The creation, distribution, transmission, public display or
                        ...
                        trademark, trade secret, or moral rights of any third party_
                    </p>
                    <p>
                    ...
                    <p>
                        6.5 Your Contributions are not unsolicited or unauthorised
                    ...
                    <p>
                        6.8 Your Contributions are not used to harass or threaten (in
                    ...
                    <p>
                        6.10 Your Contributions do not violate the privacy or publicity
                        rights of any third party.
                    </p>
                    <p>
                        6.11 Your Contributions do not violate any applicable law
                        concerning child pornography or otherwise intended to protect
                        the health or well-being of minors.
                    </p>
                    <p>
                        6.12 Your Contributions do not include any offensive comments
                        that are connected to race, national origin, gender, sexual
                        preference, or physical handicap.
                    </p>
                    <p>
                        6.13 Your Contributions do not otherwise violate or link to
                    ...
                    <h4 class="article-title">7 CONTRIBUTION LICENCE</h4>
                    <p>
                        ...
                        retitle, archive, store, cachet publicly display, reformat,
                        ...
                        in other works, such as Contributions, and grant and authorise
                        sublicences of the foregoing. The use and distribution may occur
                    ...
                    <p>
                        ...
                        locations in the Licensed Application; and (3) to pre-screen or
                    ...
                    <h4 class="article-title">8 WARRANTY</h4>
                    <p>
                    ...
                    <p>
                        ...
                        Tradersmark Pvt Ltd's sphere of influence that affect the
                        executability of the Licensed Application.
                    </p>
                    <p>
                        8.3 You are required to inspect the Licensed Application
                        immediately after installing it and notify Tradersmark Pvt Ltd
                        ...
                        within a period of seven (7) days after discovery.
                    </p>
                    <p>
                        8.4 If we confirm that the Licensed Application is defective,
                        Tradersmark Pvt Ltd reserves a choice to remedy the situation
                    ...
                    <h4 class="article-title">9 PRODUCT CLAIMS</h4>
                    <p>
                        Tradersmark Pvt Ltd and the End-User acknowledge that
                        Tradersmark Pvt Ltd, and not the Services, is responsible for
                    ...
                    <h4 class="article-title">10 CONTACT INFORMATION</h4>
                    <p>
                    ...
                    <p>
                        Retzvad Tsigo <br />
                        3 Aberdeen Rd, Harare, Zimbabwe <br />
                        tech@tradersmark-co.zw
                    </p>
                    <h4 class="article-title">11 TERMINATION</h4>
                    <p>
                        The licence is valid until terminated by Tradersmark Pvt Ltd or
                        by You. Your rights under this licence will terminate
                        automatically and without notice from Tradersmark Pvt Ltd if You
                        fail to adhere to any term(s) of this licence. Upon Licence
                    ...
                    <p>
                        Tradersmark Pvt Ltd represents and warrants that Tradersmark Pvt
                    ...
                    <p>
                        ...
                        Licence Agreement and &mdash; upon Your acceptance of the terms
                        and conditions of this Licence Agreement, Apple will have the
                    ...
                    <h4 class="article-title">13 INTELLECTUAL PROPERTY RIGHTS</h4>
                    <p>
                        Tradersmark Pvt Ltd and the End-User acknowledge that, in the
                        event of any third-party claim that the Licensed Application or
                        the End-User's possession and use of that Licensed Application
                        infringes on the third party's intellectual property rights,
                        Tradersmark Pvt Ltd, and not the Services, will be solely
                        responsible for the investigation, defence, settlement, and
                        discharge or any such intellectual property infringement claims.
                    </p>
                    <h4 class="article-title">14 APPLICABLE LAW</h4>
                    <p>
                        This Licence Agreement is governed by the laws of Zimbabwe
                        excluding its conflicts of law rules.
                    </p>
                    <h4 class="article-title">15 MISCELLANEOUS</h4>
                    <p>
            ...
            <div class="col-lg-12">
                ...
                >
                    <div class="copyright-text">
                        <p>
                            Copyright © 2022 O3 Plus. Powered by Tradersmark. All rights
                            reserved.
                        </p>
                    </div>
                </div>
